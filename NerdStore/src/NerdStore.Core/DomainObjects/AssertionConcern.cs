...
namespace NerdStore.Core.DomainObjects
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentLessEqual(long value, long minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentLessEqual(double value, double minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentLessEqual(float value, float minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentLessEqual(int value, int minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentLessEqual(decimal value, decimal minimum, string message)
        {
            if (value <= minimum)
            {
                throw new DomainException(message);
        ...
        protected void SelfAssertArgumentRange(decimal value, decimal minimum, decimal maximum, string message)
        {
            AssertionConcern.AssertArgumentRange(value, minimum, maximum, message);
        }
